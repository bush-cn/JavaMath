...
/**
 *
 * 选择相加的两个矩阵的大小，并传递给CalMatrixSub
 *
 * @author YangChaoyu
 * @date 2023/12/17 17:35
**/
public class MatrixSub extends BaseActivity {
    /**
     *
     * 初始化界面
     *
    ...
    private void showMatrixSizeDialog() {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                //传递矩阵大小
                Intent intent = new Intent(MatrixSub.this, CalMatrixSub.class);
        ...
        builder.setNegativeButton("取消", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Intent intent = new Intent(MatrixSub.this, MatrixActivityGeneral.class);
                startActivity(intent);
                dialog.dismiss();
                //取消之后退回原来界面
            }
