...
import com.buaa.ExpressionParser.Constants;
import com.buaa.ExpressionParser.ExpressionParser;
...
public class MainActivity extends BaseActivity {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    ...
                    case 3:
                        ...
                        break;
                    case 4:
                        StatisticActivity.actionStart(context);
                        break;
                    case 5:
                        MatrixActivityGeneral.actionStart(context);
                        break;
                    case 6:
                        LaTeXActivity.actionStart(context);
                        break;
                    default:
    ...
    class FastCalc extends Thread implements Runnable {
        ...
        public void run() {
            ...
            final String[] value = ExpressionParser.calculation(exp);
